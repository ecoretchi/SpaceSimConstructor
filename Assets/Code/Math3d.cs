 ...
 * Performance
 This code is not optimized for performance yet. If you need to call one or more of these functions thousands of times per frame, follow the the guidelines here: http://www.performancesimulations.com/wp/how-to-get-big-speed-increases-in-unitys-physics-or-any-math-heavy-code/
...
public class Math3d {
    ...
    /// <summary>
    /// Alternative for Quaternion.LookRotation
    /// </summary>
    ...
    /// </remarks>
    /// <param name="childPosition">output</param>
    /// <param name="childRotation">output</param>
    ...
    /// <summary>
    /// pixel distance from the mouse pointer to a line.
    /// </summary>
    /// <remarks>
